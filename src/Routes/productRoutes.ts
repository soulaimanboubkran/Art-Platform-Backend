...
router.get("/products/:product_id", (req, res, next) => productController.getProductById(req, res, next));

// Get products by seller ID (paginated)
router.get("/products/seller/:seller_id", 
  AuthMiddleware.verifyToken,
  AuthMiddleware.authorizeRole(UserRole.SELLER, UserRole.ADMIN),
  (req, res, next) => productController.getProductsBySellerId(req, res, next));

// Get products by category (paginated)
router.get("/products/category/:category_id",
   (req, res, next) => productController.getProductsByCategory(req, res, next));
